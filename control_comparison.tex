...
We finish this article with a quick presentation of the Open-Loop
...
similar to the CEC policy, which better takes into account our
knowledge of the uncertainty in the system.
...
solved, based on the most recent knowledge of the uncertainty in the
...
\Cref{fig:bellman_olfc_vals}. The emprical distribution is generated
