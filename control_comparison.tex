...
\todo[inline]{Investigate Bertsekas paper regarding approximations (at
  least for CEC), and see if we get the same results}
...
made on the example pricing problem introduced in \Cref{sec:bellman_example_markdown}.
...
\Cref{fig:bellman_det_policy_difference} shows this difference, which
