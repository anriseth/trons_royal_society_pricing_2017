...
\todo[inline]{Can we get error bounds comparing $\widetilde{v}$ and
  $v$? Maybe using ideas from~\cite{bertsekas2005survey}
...
\begin{table}[htbp]
  ...
  \caption{TODO. Note that the values are an order of magnitude
    smaller than in the comparison between Bellman and CEC shown in \Cref{tbl:paramcomparison}}\label{tbl:paramcomparisons_olfc}
  \todo[inline]{reference}
\end{table}
