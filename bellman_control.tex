...
The state $S_t$ denotes the stock of a product at time $t$, and
...
\begin{figure}[htbp]
  ...
  \caption{The value function and corresponding
    ...
    The kinks in the value function
...
\begin{figure}[htbp]
  ...
  \caption{Simulations of the pricing system, started at $S_0=1$ % TODO: subscript _0 causes issues with label re-run warnings
    ...
    that shows the median, the quartiles and outlier prices observed
    in the simulations. The right figure is a histogram of the profits over
