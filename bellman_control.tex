...
interval $A=[a_{\mathrm{min}},a_{\mathrm{max}}]\subset\mathbb R_+$.\footnote{In
...
$(W_t)$ taking non-negative values. See, for
...
\begin{figure}[htbp]
  ...
  \caption{Simulations of the pricing system, started at $S_0=1$ % TODO: subscript _0 causes issues with label re-run warnings
    ...
    The right figure is a histogram of the total profit over
    the pricing period.
